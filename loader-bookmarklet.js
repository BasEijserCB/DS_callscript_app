javascript:(function(){
  ...
  fetch(SRC+'?t='+Date.now(),{cache:'no-store'})
    ...
    .then(function(code){
      ...
      t.style.cssText='position:fixed;bottom:20px;right:20px;z-index:1000001;background:#285dab;color:#fff;padding:12px 36px 12px 14px;border-radius:8px;font:13px "Segoe UI",sans-serif;box-shadow:0 4px 16px rgba(0,0,0,.35);max-width:300px;line-height:1.5;';
