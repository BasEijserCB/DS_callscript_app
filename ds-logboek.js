    ...
    appContainer.innerHTML =
      '<div class="app">' +
        ...
        '<div class="footer"><div class="footer-inner" style="display:flex;flex-direction:row;justify-content:space-between;align-items:center;gap:8px;">' +
          ...
          '</div>' +
        '</div></div>' +
        '<div style="text-align:center;padding:5px 14px;background:#F3F3F3;border-top:1px solid #DDDDDD;font-size:11px;color:#999999;flex-shrink:0;">DS Logboek v1.17.1</div>' +
      '</div>';
