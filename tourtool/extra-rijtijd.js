...
(function () {
  ...
  var DEPOTS = {
    ...
    'Langenhagen': { id: '1819366', land: 'DE', lat: 52.450, lon: 9.740 },
    'Leipzig':     { id: '2346892', land: 'DE', lat: 51.340, lon: 12.370 },
  ...
  function autoDepots(punt, land, eigenRit) {
    ...
    mee.forEach(function (d, i) {
      ...
      //
      // 110 en niet 100: de eerstvolgende buur ligt in de dunne regio's net
      // rond die grens (Vlissingen → Tilburg 106, Leeuwarden → Almere 100,2,
      // Enschede → Venlo 107). Op 100 hielden die drie alleen hun eigen depot
      // over. Dat zou vaak kloppen — Tilburg rijdt Zeeland zelf — maar een
      // buurdepot te veel kost een handvol GetVisits, en er een missen kost
      // de oplossing.
  ...
  function tekenDepots() {
    ...
    // De lijst komt uit DEPOTS en is dus altijd gevuld; deze guard is er
    // alleen voor het geval iemand die tabel leegmaakt.
