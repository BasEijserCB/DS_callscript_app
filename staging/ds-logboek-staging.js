...
// Functional staging baseline based on ds-logboek.js.
// Staging keeps its own wrapper/cache sizing keys and intentionally omits the
...
(function(){
  ...
  var dsHeight = parseInt(localStorage.getItem('ds_staging_height') || '620');
  var dsWide = localStorage.getItem('ds_staging_wide') === '1';
  ...
  function renderApp() {
    ...
    appContainer.innerHTML =
      '<div class="app">' +
        '<div class="header">' +
          '<span class="header-title">DS Logboek staging</span>' +
        ...
        '<div class="footer"><div class="footer-inner" style="display:flex;flex-direction:row;justify-content:space-between;align-items:center;gap:8px;">' +
          ...
          '</div>' : '') +
        '</div></div>' +
        '<div style="text-align:center;padding:5px 14px;background:#fff8e1;border-top:1px solid #ffc107;font-size:11px;color:#856404;flex-shrink:0;">STAGING functioneel · v' + STAGING_VERSION + '</div>' +
      '</div>';
    ...
    idoc.getElementById('btn-height').onclick = function() {
      ...
      localStorage.setItem('ds_staging_height', dsHeight);
      iframe.style.height = dsHeight + 'px';
      renderApp();
    };
