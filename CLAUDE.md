...
6. **Uitslag lezen**: de ranglijst in het paneel, de kolom `+ rijtijd` in de stoplijst van de geselecteerde rit, en het pilletje als het paneel klein staat. Klikken op een regel selecteert die rit in de Ritmonitor — dat werkt omdat stap 5 de rittenlijst al op dezelfde depots heeft gezet.
